...
(function() {
  var FIXTURE_COOK_JSON_URL, FIXTURE_GRAPH_JSON_URL, do_test;
  ...
  seajs.use('graph/net', function(KnowledgeNet) {
    ...
    return jQuery(function() {
      return jQuery.getJSON(FIXTURE_GRAPH_JSON_URL, function(obj) {
        return jQuery.getJSON(FIXTURE_COOK_JSON_URL, function(cook_obj) {
          return do_test(KnowledgeNet, obj['G1'], obj['G2'], obj['G3'], obj['G4'], cook_obj);
        });
      });
    });
  });

  do_test = function(KnowledgeNet, g1_obj, g2_obj, g3_obj, g4_obj, cook_obj) {
    ...
    (function() {
      var knet1, knet2, knet3, knet_cook;
    ...
    (function() {
      ...
      return test('set#is_parents_here', function() {
        ...
        p1 = {
          id: '53b23f0e6c696e5c95060000',
          parents: ['53b23f0e6c696e5c95050000']
        };
        return ok(ds.is_parents_here(p1));
      });
    })();
    (function() {
      var ds, knet;
